...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve a specific employee by ID' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update an employee by ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: 'number' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete an employee by ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: 'number' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
